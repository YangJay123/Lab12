...
public class FamilyTree
{
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			throw new TreeException("node1 does not exist");
		TreeNode node2 = root.getNodeWithName(name2);		// node whose name is name1
		if (node2 == null)
			throw new TreeException("node2 does not exist");
